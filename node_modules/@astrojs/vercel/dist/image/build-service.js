...
const service = {
  validateOptions: (options, serviceOptions) => sharedValidateOptions(options, serviceOptions, "production"),
  ...
  getURL(options, serviceOptions) {
    const fileSrc = typeof options.src === "string" ? options.src : removeLeadingForwardSlash(options.src.src);
